...
const faqI18n: Record<string, { q: Record<string, string>; a: Record<string, string> }> = {
  faq1: {
    ...
    a: { fr: 'Mentova est une plateforme d\'apprentissage crypto alimentée par Caufid, un mentor IA personnalisé. Caufid s\'adapte à votre niveau et vous guide à travers des modules structurés pour maîtriser les cryptomonnaies.', en: 'Mentova is a crypto learning platform powered by Caufid, a personalized AI mentor. Caufid adapts to your level and guides you through structured modules to master cryptocurrencies.', es: 'Mentova es una plataforma de aprendizaje crypto impulsada por Caufid, un mentor IA personalizado. Caufid se adapta a tu nivel y te guia a traves de modulos estructurados para dominar las criptomonedas.' },
  },
  faq2: {
    q: { fr: 'Comment fonctionne Caufid ?', en: 'How does Caufid work?', es: 'Como funciona Caufid?' },
    a: { fr: 'Caufid est votre mentor crypto personnel. Il analyse votre niveau, mémorise vos préférences et crée un parcours d\'apprentissage adapté. Posez-lui n\'importe quelle question sur les cryptos et il vous répondra de manière pédagogique.', en: 'Caufid is your personal crypto mentor. It analyzes your level, remembers your preferences, and creates a tailored learning path. Ask it any crypto question and it will respond pedagogically.', es: 'Caufid es tu mentor crypto personal. Analiza tu nivel, recuerda tus preferencias y crea un camino de aprendizaje adaptado. Hazle cualquier pregunta sobre criptomonedas y te respondera de manera pedagogica.' },
  },
  faq3: {
